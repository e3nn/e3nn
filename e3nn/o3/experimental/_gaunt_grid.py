    ...
    def __init__(
        ...
        *,
        ...
        if filter_ir_out is None:
            filter_ir_out = o3.s2_irreps(
                irreps_in1.lmax + irreps_in2.lmax
            )
        self.to_s2grid_in1 = o3.ToS2Grid(lmax=irreps_in1.lmax,
                                         res=(res_beta, res_alpha))
        self.to_s2grid_in2 = o3.ToS2Grid(lmax=irreps_in2.lmax,
                                        res=(res_beta, res_alpha))
        self.from_s2grid = o3.FromS2Grid(lmax=filter_ir_out.lmax,
                                        res=(res_beta, res_alpha))
