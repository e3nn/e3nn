...
class Block(nn.Module):
    def __init__(self, scalar_out, vector, scalar_in, relu):
        super().__init__()
        self.conv1 = SE3Convolution(6, 3, [(vector, SO3.repr3)], [(scalar_in, SO3.repr1)],
            bias_relu=False,
            norm_relu=False,
        ...
        self.conv2 = SE3Convolution(6, 3, [(scalar_out, SO3.repr1)], [(vector, SO3.repr3), (vector, SO3.repr3x3)],
            bias_relu=relu,
            norm_relu=False,
