...
class CNN(nn.Module):
    ...
    def __init__(self, number_of_classes):
        ...
        representations = [
            [(1, SO3.repr1)],  # 64
            [(16, SO3.repr1), (12, SO3.repr3), (4, SO3.repr5), (2, SO3.repr7)],  # (64+2*3-(5-1)) / 2 = 33
            [(16, SO3.repr1), (12, SO3.repr3), (4, SO3.repr5), (2, SO3.repr7)],  # (33 + 2) / 2 = 17
            [(16, SO3.repr1), (12, SO3.repr3), (4, SO3.repr5), (2, SO3.repr7)],  # (17 + 2) / 2 = 9
