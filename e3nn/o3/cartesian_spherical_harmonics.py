...
def _spherical_harmonics(lmax: int, x: torch.Tensor, y: torch.Tensor, z: torch.Tensor) -> torch.Tensor:
    ...
    sh_2_0 = 0.866025403784439*sh_1_0*z + 0.86602540378444*sh_1_2*x
    sh_2_1 = 0.866025403784438*sh_1_0*y + 0.866025403784438*sh_1_1*x
    sh_2_2 = -0.5*sh_1_0*x + sh_1_1*y - 0.5*sh_1_2*z
    sh_2_3 = 0.866025403784438*sh_1_1*z + 0.86602540378444*sh_1_2*y
    sh_2_4 = -0.866025403784439*sh_1_0*x + 0.866025403784439*sh_1_2*z
    if lmax == 2:
        return torch.stack([
            sh_0_0,
            sh_1_0, sh_1_1, sh_1_2,
