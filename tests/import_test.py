...
def test_import():
    from e3nn.util import plot, bounding_sphere, cache_file, default_dtype, time_logging  # noqa
    ...
    from e3nn import batchnorm, dropout, groupnorm, kernel, linear, o3, radial, rs, spherical_harmonics, tensor_product  # noqa
