...
class CNN(nn.Module):
    def __init__(self, number_of_classes):
        ...
        representations = [
            [(1, SO3.repr1)], # 64
            [(6, SO3.repr1), (4, SO3.repr3), (2, SO3.repr5), (1, SO3.repr7)], # (64+2*2-(5-1)) / 2 = 32
            [(6, SO3.repr1), (4, SO3.repr3), (2, SO3.repr5), (1, SO3.repr7)], # 32 / 2 = 16
            [(6, SO3.repr1), (4, SO3.repr3), (2, SO3.repr5), (1, SO3.repr7)], # 16
            [(6, SO3.repr1), (4, SO3.repr3), (2, SO3.repr5), (1, SO3.repr7)], # 16
            [(number_of_classes, SO3.repr1)]] # 16
        ...
        for i in range(len(representations) - 1):
            ...
            conv = SE3Convolution(5, representations[i + 1], representations[i],
             bias_relu=non_lin, norm_relu=non_lin, scalar_batch_norm=True, radial_type="triangles", stride=2 if i < 2 else 1, padding=2)
